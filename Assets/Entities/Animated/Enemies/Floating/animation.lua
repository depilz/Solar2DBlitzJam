...
function Animation:create(parent, x, y)
  ...
  -- self._shadow = display.newImageRect(self.group, "Assets/Entities/Animated/Enemies/Floating/shadow.png", 36, 36)
  self._enemy = display.newImageRect(self.group, "Assets/Entities/Animated/Enemies/Floating/floating.png", 28, 28)
end
